...
| `polyglot` | A greeting in any language | "world" in that language | Shows LangChain integration |
...
├── docs/
│   └── langchain-polyglot-tool.md    # LangChain integration guide
...
The `polyglot` tool demonstrates how MCP tools can call external AI services using LangChain.
...
| Language | Greeting | Expected Output |
|----------|----------|-----------------|
| English | hello | world |
| Spanish | hola | mundo |
...
For a deeper dive into how this tool works, see [docs/langchain-polyglot-tool.md](docs/langchain-polyglot-tool.md).
